...
class Rails extends Transparent
{
    ...
    public function place(Item $item, Block $block, Block $target, $face, $fx, $fy, $fz, Player $player = null){
        ...
        * to adjacent blocks
        */
        if (in_array($cube, [Vector3::SIDE_WEST + self::ABOVE][1]) && [self::STRAIGHT_EW, self::SLOPE_W, self::CURVE_SE, self::CURVE_NE] && (in_array($cube[Vector3::SIDE_EAST][1], [self::STRAIGHT_EW, self::SLOPE_E, self::CURVE_SW, self::CURVE_NW, -1]) ||
        ...
        */
        ...
        //self::CURVE_NE;
//////////////////////////////////////////////////////////////////////
        if (($cube[Vector3::SIDE_NORTH][1] != -1 || $cube[-Vector3::SIDE_NORTH][1] == self::SLOPE_S) && ($cube[Vector3::SIDE_WEST][1] != -1 || $cube[-Vector3::SIDE_WEST][1] == self::SLOPE_E)) {
            if ((in_array($cube[Vector3::SIDE_NORTH][1], [self::STRAIGHT_NS, self::SLOPE_N, self::CURVE_SE, self::CURVE_SW]) || $cube[-Vector3::SIDE_NORTH][1] == self::SLOPE_S) && in_array(Vector3::SIDE_WEST, $cube)) {
        ...
        $cube[Vector3::SIDE_NORTH] = [$this->getSide(Vector3::SIDE_NORTH)];

        $cube[Vector3::SIDE_WEST] = [$this->getSide(Vector3::SIDE_WEST)];
